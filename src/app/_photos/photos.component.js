...
var photos_service_1 = require("./_service/photos.service");
// From http injectable get Map operator
require("rxjs/add/operator/map");
var AppPhotos = /** @class */ (function () {
    ...
    AppPhotos.prototype._initProducts = function () {
        var _this = this;
        // get products
        this._product.getProducts().subscribe(function (iphotos) { return _this.iphotos = iphotos; });
    };
